<template>
  <section class="slider">
    <button @click="changeSlidePrev()" class="slide_prev" ref="slidePrev">&#9668;</button>

    <button @click="changeSlideNext()" class="slide_next" ref="slideNext">&#9658;</button>
...
export default {
  data() {
    return {
      slides: [
        // массив со всеми картинками для слайдеров
